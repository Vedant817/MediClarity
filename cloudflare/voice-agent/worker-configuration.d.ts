/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6893fe4f3a57f0c0a0bac66a8df11ac7)
...
interface __BaseEnv_Env {
	...
	PatientVoiceAgent: DurableObjectNamespace<import("./src/server").PatientVoiceAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "PatientVoiceAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_ORIGIN" | "ALLOWED_ORIGIN" | "TOKEN_AUDIENCE">> {}
}
